...
kors.append(int(input('1번학생 국어 점수는?')))
engs.append(int(input('1번학생 영어 점수는?')))
mats.append(int(input('1번학생 수학 점수는?')))

names.append(input('2번학생 이름은?'))
kors.append(int(input('2번학생 국어 점수는?')))
engs.append(int(input('2번학생 영어 점수는?')))
mats.append(int(input('2번학생 수학 점수는?')))

names.append(input('3번학생 이름은?'))
kors.append(int(input('3번학생 국어 점수는?')))
engs.append(int(input('3번학생 영어 점수는?')))
mats.append(int(input('3번학생 수학 점수는?')))
