...
# 단, 성적데이터를 담고 있는 객체와
# 성적처리에 필요한 기능별로 구성된 객체등으로 나눠 작성

# OOP에서 클래스의 종류
# 1. 값만 저장하는 클래스     : VO, DTO
# 2. 기능만 저장하는 클래스    : Service (BO), DAO
# 3. UI 처리만 저장하는 클래스 : UO
