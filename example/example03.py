...
result = '잘못 입력하셨습니다.'
for i in range(1,10):
    if (0 < dan < 10): print(f'{dan} x {i} = {dan*i}')
    else: print(result)
...
elif cardno == 356912: result = 'JCB카드 신한카드'
elif cardno == 404825: result = 'JCB카드 국민카드'
elif cardno == 438676: result = '비자카드 비씨카드'
...
elif daytime == 'midday' or daytime == 'noon': result = '점심시간(7-12) '
